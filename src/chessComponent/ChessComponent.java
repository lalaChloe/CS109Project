...
public class ChessComponent extends SquareComponent{
    ...
    public boolean canMoveTo(SquareComponent[][] chessboard, ChessboardPoint destination) {
        ...
        if ((Math.abs(destination.getX()-this.getChessboardPoint().getX())<=1&&destination.getY()==this.getChessboardPoint().getY())||(Math.abs(destination.getY()-this.getChessboardPoint().getY())<=1&&destination.getX()==this.getChessboardPoint().getX())){
