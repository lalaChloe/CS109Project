...
//		try {
//            MusicPlayer player = new MusicPlayer("E:\\a.wav");
...
//	}
    ...
    public MusicPlayer2(String srcPath) {
     ...
     * @return 返回当前对象
     */
    public MusicPlayer2 setLoop(boolean isLoop) {
        this.isLoop = isLoop;
        return this;
    }
     ...
     * @return 返回当前对象
     */
    public MusicPlayer2 setVolumn(float newVolumn) {
